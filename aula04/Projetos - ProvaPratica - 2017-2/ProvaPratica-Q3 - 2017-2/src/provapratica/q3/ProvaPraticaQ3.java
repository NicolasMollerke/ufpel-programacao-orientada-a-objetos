...
public class ProvaPraticaQ3 {
    ...
    public static void main(String[] args) {
        ...
        // -- Processa Vôo Premium ---------------------------------------------
        aviaoPremium = new AviaoPremium(666, new Data(26,2,2018), 7, 3);
        ListaDePassageiros repositorio = new ListaDePassageiros();
        repositorio.inicializaRepositorio1();
        System.out.println("##################################################################");
        System.out.print(repositorio.toString());
        Embarque.processaEmbarque(aviaoPremium, repositorio);
        if (Verifica.situacao04(aviaoPremium)) {
            System.out.println("------------------------------------------------------------------");
            System.out.println("Número do Vôo: " + aviaoPremium.getNumeroDoVoo());
            System.out.println("Data do Vôo: " + aviaoPremium.getData());
            System.out.println("Número de Assentos Livres: " + aviaoPremium.vagas());
