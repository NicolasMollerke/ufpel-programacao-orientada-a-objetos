...
public class Verifica {
    ...
    public static boolean situacao04(AviaoPremium aviao) {
        if (aviao.getNumeroDoVoo() != 666) {
            System.out.println("Erro: O número do vôo está errado.");
            return false;
        } 
        if (!aviao.getData().toString().equals("26/2/2018")) {
        ...
        if (aviao.vagas() != 1) {
            System.out.println("Erro: O número de vagas livres deve ser 1 neste momento.");
            return false;
        } 
        if (aviao.proximoLivre() != 6 ) {
            System.out.println("Erro: O próximo assento comum livre deveria ser o de número 6.");
            return false;
        }
        if (!aviao.ocupa(aviao.proximoLivre())) {
            System.out.println("Erro: O assento comum de número 6 deveria estar disponível para ocupação.");
            return false;
        }
        if (aviao.proximoLivre() != -1) {
            System.out.println("Erro: Não deveria haver assentos comuns disponíveis neste momento.");
            return false;
        }
        if (aviao.proximoPremiumLivre() != -1) {
            System.out.println("Erro: Não deveria haver assentos Premium disponíveis neste momento.");
            return false;
        }
         if (aviao.vagas() != 0) {
            System.out.println("Erro: O número de vagas livres deveria ser 345 neste momento.");
